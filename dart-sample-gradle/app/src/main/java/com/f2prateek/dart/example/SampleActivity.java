...
public class SampleActivity extends Activity {
  ...
  @Bind(R.id.default_key_extra) TextView defaultKeyExtraTextView;
  @Bind(R.id.string_extra) TextView stringExtraTextView;
  @Bind(R.id.int_extra) TextView intExtraTextView;
  @Bind(R.id.parcelable_extra) TextView parcelableExtraTextView;
  @Bind(R.id.optional_extra) TextView optionalExtraTextView;
  @Bind(R.id.parcel_extra) TextView parcelExtraTextView;
  @Bind(R.id.default_extra) TextView defaultExtraTextView;
