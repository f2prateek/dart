...
public class DartTest {
  ...
  @Test public void zeroInjectionsInjectDoesNotThrowException() {
    ...
    Dart.inject(example, null, null);
    assertThat(Dart.INJECTORS).contains(entry(Example.class, Dart.NO_OP));
  }

  @Test public void injectingKnownPackagesIsNoOp() {
    Dart.inject(new Activity());
    assertThat(Dart.INJECTORS).isEmpty();
    Dart.inject(new Object(), new Activity());
    assertThat(Dart.INJECTORS).isEmpty();
  }
}
