        ...
        JavaFileObjects.forSourceString(
            ...
            Joiner.on('\n')
                .join( //
                    ...
                    "    }",
                    "    public Test__IntentBuilder.RequiredSequence<Test__IntentBuilder.ResolvedAllSet> gotoTest() {",
        ...
        JavaFileObjects.forSourceString(
            ...
            Joiner.on('\n')
                .join( //
                    ...
                    "      this.context = context;",
                    "    }",
                    "    public Test__IntentBuilder.ResolvedAllSet gotoTest() {",
                    "      return test.navigation.Test__IntentBuilder.getInitialState(context);",
                    "    }",
                    "  }",
                    "}"));
        ...
        JavaFileObjects.forSourceString(
            ...
            Joiner.on('\n')
                .join( //
                    ...
                    "      this.context = context;",
                    "    }",
                    "    public Test1__IntentBuilder.ResolvedAllSet gotoTest1() {",
                    "      return test.navigation.Test1__IntentBuilder.getInitialState(context);",
                    "    }",
                    "    public Test2__IntentBuilder.RequiredSequence<Test2__IntentBuilder.ResolvedAllSet> gotoTest2() {",
                    "      return test.navigation.Test2__IntentBuilder.getInitialState(context);",
                    "    }",
                    "    public Test3__IntentBuilder.ResolvedAllSet gotoTest3() {",
        ...
        JavaFileObjects.forSourceString(
            ...
            Joiner.on('\n')
                .join( //
                    ...
                    "      this.context = context;",
                    "    }",
                    "    public Test3__IntentBuilder.RequiredSequence<Test1__IntentBuilder.ResolvedAllSet> gotoTest1() {",
                    "      return test.navigation.Test1__IntentBuilder.getInitialState(context);",
                    "    }",
                    "    public Test2__IntentBuilder.RequiredSequence<Test2__IntentBuilder.ResolvedAllSet> gotoTest2() {",
                    "      return test.navigation.Test2__IntentBuilder.getInitialState(context);",
                    "    }",
                    "    public Test3__IntentBuilder.RequiredSequence<Test3__IntentBuilder.ResolvedAllSet> gotoTest3() {",
                    "      return test.navigation.Test3__IntentBuilder.getInitialState(context);",
                    "    }",
                    "  }",
                    "}"));
